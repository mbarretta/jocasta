...
valid one, and the `validate` workflow turns red on anything malformed,
unreachable, unowned or duplicated. The exact format, with the reason every field earns its
